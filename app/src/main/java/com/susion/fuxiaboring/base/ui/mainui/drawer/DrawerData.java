package com.susion.fuxiaboring.base.ui.mainui.drawer;

import android.content.Context;

import com.susion.fuxiaboring.R;
import com.susion.fuxiaboring.base.SAppApplication;
import com.susion.fuxiaboring.base.ui.AppInfoActivity;
import com.susion.fuxiaboring.base.ui.AuthorActivity;
import com.susion.fuxiaboring.base.ui.CollectActivity;
import com.susion.fuxiaboring.base.ui.SettingActivity;
...
public class DrawerData {
    ...
    public static void onItemClick(Context context, String type) {
        switch (type) {
            case DRAWER_AUTHOR://关于作者
                AuthorActivity.start(context);
                break;

            case DRAWER_COLLECT://我的收藏
                CollectActivity.start(context);
                break;

            case DRAWER_APP_INFO://应用信息
